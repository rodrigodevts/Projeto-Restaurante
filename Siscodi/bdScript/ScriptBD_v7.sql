...
--
-- Table structure for table `vendaprazo`
--

DROP TABLE IF EXISTS `vendaprazo`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `vendaprazo` (
  `idVendaPrazo` int(11) NOT NULL AUTO_INCREMENT,
  `formapagamento` varchar(200) DEFAULT NULL,
  `idClientes` int(11) NOT NULL,
  `idVenda` int(11) NOT NULL,
  `QUITADO` varchar(3) DEFAULT NULL,
  `dataQuitado` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  KEY `idVendaPrazo` (`idVendaPrazo`),
  KEY `IdVenda` (`idVenda`)
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER TRGBI_QUITADO
BEFORE INSERT ON VENDAPRAZO
FOR EACH ROW
BEGIN
	IF(NEW.FORMAPAGAMENTO = 'A PRAZO') THEN
		SET NEW.QUITADO = 'NAO';
	END IF;
END */;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 trigger TRGU_DATAQUITADO
BEFORE UPDATE
ON VENDAPRAZO
for each row
begin
     IF(NEW.QUITADO = 'SIM')THEN
		SET NEW.DATAQUITADO = current_timestamp();
     END IF;
end */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER Fecha_Pedido AFTER INSERT
...
-- Dump completed on 2020-04-12  0:02:27
